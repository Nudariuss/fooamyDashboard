...
class DetailAccountOperation extends Controller
{
  public function index($id, $role = 'customer')
  {
    ...
    if ($role === 'driver' && empty($account['plat'])) {
      $account['plat'] = 'Unknown Plat'; // Jika tidak ada plat, beri nilai default
  }
    ...
    // Dummy data untuk status driver
    $driverStatuses = [
      ['status_driver' => 'Stand By', 'date' => '2023-01-24', 'time' => '11:45'],
      ['status_driver' => 'Pick Up', 'date' => '2023-01-25', 'time' => '12:45'],
    ];

    return view('content.account.detail-account-operation', compact('account', 'driverStatuses', 'role'));
  }
}
