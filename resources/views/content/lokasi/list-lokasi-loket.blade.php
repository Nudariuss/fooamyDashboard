...
@section('page-script')
    @vite('resources/assets/js/list-lokasi-loket.js')
@endsection

@section('title', 'List Lokasi Loket')

@section('content')
<div class="container-fluid">
    <x-judul title="List Lokasi Loket" />
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group input-group-merge short-searchbar">
                        ...
                        <input type="text" class="form-control" placeholder="Cari Lokasi Loket"
                              aria-label="Cari Lokasi Loket" aria-describedby="basic-addon-search31" />
                    </div>
                </div>
                <div class="col-md-6 d-flex justify-content-end align-items-center gap-2">
                    <a href="{{ route('add-lokasi-loket') }}" class="btn btn-primary">
        ...
        <div class="card-datatable table-responsive text-nowrap">
            <table class="table table-striped border-bottom">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        <td><input type="checkbox" class="form-check-input select-item" data-id="{{ $item['id_loket'] }}"></td>
                        <td>{{ $item['id_loket'] }}</td>
                        <td>{{ $item['id_hq'] }}</td>
                        <td>{{ $item['nama'] }}</td>
                        <td>{{ $item['alamat'] }}</td>
                        ...
                        <td>
                            <a href="{{ route('detail-lokasi-loket', ['id_loket' => $item['id_loket']]) }}" class="btn btn-icon"><i class="fi fi-br-pencil"></i></a>
