...
@section('page-script')
    @vite('resources/assets/js/list-promo-aplikasi.js')
@endsection

@section('title', 'List Keluhan Aplikasi')

@section('content')
<div class="container-fluid">
    <x-judul title="List Keluhan Aplikasi" />
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb breadcrumb-style1">
          ...
          <li class="breadcrumb-item active">
            <a href="{{ url('/keluhan/aplikasi/list') }}">Aplikasi</a>
          </li>
      </ol>
  </nav>
          ...
          <table class="table table-striped border-bottom">
              ...
              <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    <td>
                      <a href="{{ route('detail-keluhan-aplikasi', ['id_keluhan' => $item['id_keluhan']]) }}">
                          {{ $item['judul_keluhan'] }}
                      </a>
                    </td>
                    <td>{{ $item['email'] }}</td>
