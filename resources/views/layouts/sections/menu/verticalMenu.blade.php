<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo d-flex justify-content-center align-items-center">
    <a href="{{ url('/') }}" class="app-brand-link">
        <img src="{{ asset('assets/img/favicon/LOGOV1-B.svg') }}" alt="Fooamy Logo" class="app-brand-logo demo" style="width: 150px; height: auto;" />
    </a>
  ...
  <ul class="menu-inner py-1">
    @foreach ($menuData[0]->menu as $menu)
      ...
      // Periksa apakah menu memiliki key 'routes' untuk mencakup semua route terkait
      if (isset($menu->routes) && in_array($currentRouteName, $menu->routes)) {
            $activeClass = 'active';
